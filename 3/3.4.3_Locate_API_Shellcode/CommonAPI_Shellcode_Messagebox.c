//该函数主要实现自动定位API messagebox的地址，以适应不同系统API入口地址不同的需求
//Reference:http://www.wangzhixian.org/0Day2/3.2Calculate%20digest%20of%20function%20name%20for%20general%20shellcode/article.html
int main()
{    
    _asm{
            nop
